 ...
 * This service provides the logic and API payload
 * needed to send the "Generic Template" which...
 */
...
export const sendGenericTemplate = async (recipientId: string, config: BotConfig) => {
  ...
  try {
    // In a real environment, this would be a fetch call
    ...
    return { success: true, message_id: "mid.s..." };
  } catch (error) {
